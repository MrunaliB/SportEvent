...
//    public static final String FIREBASE_GALLERY_BUCKET = BuildConfig.FIREBASE_GALLERY_BUCKET_URL;
    ...
    public static final String ASSIGNED_TASKS_FRAGMENT_TITLE = "Assigned";

    public static final String LIST_TYPE = "listType";
    public static final String POSITION = "position";
    public static final String ROLE_ADMIN = "ADMIN";
    public static final String ROLE_STUDENT = "STUDENT";
    public static final String ROLE_SPORTS_TRAINER = "SPORTS_TRAINER";
    public static final String ROLE_EXECUTIVE = "EXECUTIVE";
    public static final String ROLE_USER = "USER";
    public static final String FIREBASE_OBJECT_USER = "User";
    public static final String KEY_FORM_TYPE = "formType";
    public static final String SIGNUP_FORM = "signUp";
    public static final String KEY_BUNDLE = "bundle";
    public static final String MSG_RESET_PASS_MAIL = "Reset password email sent to registered email id.";
